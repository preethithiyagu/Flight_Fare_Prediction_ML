...
reset_button = st.button("Reset")  # Move the reset button outside the condition
...
# Move the reset button inside the condition
if reset_button:
    st.text_input("Enter departure date (YYYY-MM-DD): ")
    st.text_input("Enter departure place: ")
    st.text_input("Enter arrival place: ")
    st.number_input("Enter number of persons:", min_value=1, step=1)
